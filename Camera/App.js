...
export default class App extends PureComponent {
  ...
  renderFlashControl() {
    ...
    return (
      ...
      >
        <Icon name="add-outline" style={[styles.buttonIcon, { fontSize: 28, color: flashEnabled ? '#333' : '#FFF' }]} />
      </TouchableOpacity>
    );
  }
              ...
              {this.props.hideSkip ? null : (
                <View style={[styles.buttonGroup, { marginLeft: 8 }]}>
                  <TouchableOpacity
                    ...
                    activeOpacity={0.8}
                  >
                    <Icon name="add-outline" size={40} color="white" style={styles.buttonIcon} />
            ...
            <View style={[styles.buttonActionGroup, { marginTop: 28 }]}>
              <View style={styles.buttonGroup}>
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                >
                  <Icon name="add-outline" size={40} style={styles.buttonIcon} />
